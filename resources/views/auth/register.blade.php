                        ...
                        <div class="p-5">
                            ...
                            <form method="POST" class="user" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input id="password-confirm" type="password" class="form-control form-control-user" name="password_confirmation" required autocomplete="new-password" placeholder="Repetez le mot de passe">
                                    </div>
                                </div>
                            ...
                            <div class="text-center">
                                <a class="small" href="login.html">Avez vous déjà un compte? s'identifier!</a>
                            </div>
                        </div>
                    </div>
                </div>
